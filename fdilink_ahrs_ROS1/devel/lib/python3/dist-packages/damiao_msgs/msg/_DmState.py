...
"""autogenerated by genpy from damiao_msgs/DmState.msg. Do not edit."""
import codecs
import sys
...
class DmState(genpy.Message):
  _md5sum = "89fbfe7693049e9b6aa6dcc6b1b42342"
  _type = "damiao_msgs/DmState"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string[] joint_names
float64[] pos
float64[] vel
float64[] tau"""
  __slots__ = ['joint_names','pos','vel','tau']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DmState, self).__init__(*args, **kwds)
